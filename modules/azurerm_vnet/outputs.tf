output "id" {
  ...
  value       = var.name == "" ? azurerm_virtual_network.vnet.0.id : data.azurerm_virtual_network.vnet.0.id
}
...
output "location" {
  ...
  value       = var.name == "" ? azurerm_virtual_network.vnet.0.location : data.azurerm_virtual_network.vnet.0.location
}

output "address_space" {
  description = "The address space of the vNet"
  value       = var.name == "" ? azurerm_virtual_network.vnet.0.address_space : data.azurerm_virtual_network.vnet.0.address_space
}
