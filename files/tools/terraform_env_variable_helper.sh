...
# usage: run the export in either line 8 or 9 before this script or edit lines 8 or 9 in this script before running
...
echo -e "Usage: You must have an active az cli login 'az login' before this script will work"
echo -e "Usage: Run the export in either line 8 or 9 before this script or edit lines 8 or 9 in this script before running"
echo -e "Usage: The variable \$YourSP needs to be set and currently has a value of Service Principal: >>>>> $YourSP <<<<<"
