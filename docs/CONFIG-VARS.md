...
**NOTE**: By default, the `PLPGSQL` and `PGCRYPTO` extensions are automatically add to the `azure.extensions` configuration of all external PostgreSQL instances, as the 2 extensions are required.
