...
| configurations | Configurations to enable on the PostgreSQL Database server instance | map | {} | More details can be found [here](https://docs.microsoft.com/en-us/azure/postgresql/howto-configure-server-parameters-using-cli) |
