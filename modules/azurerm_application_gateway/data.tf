...
data "azurerm_key_vault_certificate" "ssl_cert" {
  count        = var.create_app_gateway && var.key_vault_name != null && var.app_gateway_config != null && lookup(var.app_gateway_config, "ssl_certificate", null) != null ? length([for cert in var.app_gateway_config.ssl_certificate : cert if lookup(cert, "certificate_name", null) != null && lookup(cert, "data", null) == null]) : 0
...
data "azurerm_key_vault_certificate" "backend_cert" {
  count        = var.create_app_gateway && var.key_vault_name != null && var.app_gateway_config != null && lookup(var.app_gateway_config, "backend_trusted_root_certificate", null) != null ? length([for cert in var.app_gateway_config.backend_trusted_root_certificate : cert if lookup(cert, "certificate_name", null) != null && lookup(cert, "data", null) == null]) : 0
